const Berita = () => {
  return (
    <div className='bg-white w-full lg:w-[24.2%] m-1 rounded mb-2'>
    <div className='max-w-sm p-4 rounded shadow animate-pulse md:p-6 dark:border-gray-700'>
        <div className='flex item-center justify-center h-48 mb-4 bg-gray-300 backdrop:rounded dark:bg-gray-700'>
